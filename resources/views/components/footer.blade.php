    ...
    <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8 border-b border-white/5 pb-8">
        <div class="space-y-6 text-center md:text-left">
            <div class="flex items-center justify-center md:justify-start gap-2">
                <div class="space-y-4"><img src="{{ asset('images/LOGO_LS_TRANSPARAN.png') }}" 
     class="h-16 w-auto opacity-90 brightness-110 drop-shadow-[0_0_6px_rgba(255,255,255,0.4)]" alt="LeafShelf Logo">
            ...
            <p class="text-olivine/60 text-sm leading-relaxed">
                Membangun jembatan literasi digital demi masa depan yang lebih cerah. Turn a New Leaf!
            </p>
        </div>
