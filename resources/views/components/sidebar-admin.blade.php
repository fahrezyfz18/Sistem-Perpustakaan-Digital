<aside class="w-64 h-screen bg-primary text-white fixed shadow-xl font-sans">
    ...
    <!-- Logo / Title -->
    <div class="h-16 px-6 flex items-center text-2xl font-semibold border-b border-accent gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-olivine" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M12 6l-2-2m0 0L8 6m2-2v6m0 0l2 2m-2-2l-2 2m6 4H6a2 2 0 01-2-2V6a2 2 0 012-2h2" />
        </svg>
        Admin Panel
    </div>
    ...
    <nav class="p-4 space-y-3 text-base">
        ...
        <form method="POST" action="{{ route('logout') }}" class="mt-6">
            @csrf
            <button
                class="w-full flex items-center gap-3 px-4 py-2 bg-secondary rounded-lg hover:bg-camel transition">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
