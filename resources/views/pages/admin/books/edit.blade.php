...
<div class="min-h-screen bg-background flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-2xl bg-white rounded-2xl shadow-lg border border-gray-100">
        ...
        <!-- SUCCESS -->
        @if(session('success'))
            <div class="mx-6 mt-6 p-4 rounded-lg bg-green-100 border border-green-300 text-green-700">
                {{ session('success') }}
            </div>
        @endif
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            oninput="if(this.value < 1900) this.value='';"
                            class="w-full border border-gray-300 rounded-lg p-3
                                   placeholder:text-gray-400 placeholder:text-sm
                                   focus:ring-2 focus:ring-primary
                                   focus:border-primary
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full border border-gray-300 rounded-lg p-3
                               ...
                               focus:ring-2 focus:ring-primary
                               focus:border-primary
                               outline-none transition duration-200">{{ old('deskripsi', $buku->deskripsi) }}</textarea>
